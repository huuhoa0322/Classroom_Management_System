...
export default function StudentFinancialPage() {
  ...
  // Data hooks
  const { data: packages, isLoading: loadingPackages } = useStudentPackages(studentId);
  const { data: payments, isLoading: loadingPayments } = useStudentPayments(studentId, paymentPage);
